...
|
|     $HeadURL: https://svn.code.sf.net/p/e107german/code/trunk/e107_0.7/e107_languages/German/admin/lan_download.php $ 
|     $Revision: 268 $
|     $Date: 2013-03-19 20:23:07 +0100 (Di, 19. Mrz 2013) $
|     $Id: lan_download.php 268 2013-03-19 19:23:07Z lars78 $
|     $Author: lars78 $
+----------------------------------------------------------------------------+
*/
define("DOWLAN_1", "Download zur Datenbank hinzugefügt.");
define("DOWLAN_2", "Download in der Datenbank upgedatet.");
define("DOWLAN_3", "Download gelöscht.");
define("DOWLAN_4", "Bitte markieren Sie die Bestätigungsbox um den Download zu löschen");
...
define("DOWLAN_8", "Keine änderungen, es wurde nichts gespeichert.");
...
define("DOWLAN_51", "Downloads durchsuchen/aktualisieren");
...
define("DOWLAN_113", "Benutzerklassen");
define("DOWLAN_114", "Neues Limit hinzufügen");
define("DOWLAN_115", "Limits aktualisieren");
define("DOWLAN_116", "Ein Limit für diese Benutzerklasse besteht bereits");
define("DOWLAN_117", "Limit erfolgreich hinzugefügt");
define("DOWLAN_118", "Limit nicht hinzugefügt - unbekannter Fehler");
...
define("DOWLAN_126", "Aktivierungsstatus aktualisiert");
define("DOWLAN_127", "Bitte nur Dateigrösse eingeben, falls es sich um eine externe Datei handelt.");
define("DOWLAN_128", "Mirrors");
define("DOWLAN_129", "Bitte frei lassen falls keine Mirrors genutzt werden.");
...
define("DOWLAN_137", "Sind Sie sicher diesen Mirror löschen zu wollen?");
define("DOWLAN_138", "Bestehnde Mirrors");
define("DOWLAN_139", "Adresse");
define("DOWLAN_140", "Laden Sie dies lokalen Bilder nach ".e_FILE."downloadimages um sie hier anzeigen zu lassen, oder geben Sie sie komplette Url zum Bild an, falls es sich um ein externes handelt");
define("DOWLAN_141", "Ort");
