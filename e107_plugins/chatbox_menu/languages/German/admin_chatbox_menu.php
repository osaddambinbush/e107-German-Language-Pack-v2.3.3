...
define("CHBLAN_24", "Einen Tag");
define("CHBLAN_25", "Eine Woche");
define("CHBLAN_26", "Einen Monat");
define("CHBLAN_27", "- All Einträge löschen -");
// define("CHBLAN_28", "Chatbox pruned.");

define("CHBLAN_29", "Chatbox innerhalb eines Scrolling Layer's anzeigen mit höhe [x]"); // [x] will be replaced automatically
// define("CHBLAN_30", "Layer height");
define("CHBLAN_31", "zeige Smilies");
define("CHBLAN_32", "Moderator Benutzerklasse");
