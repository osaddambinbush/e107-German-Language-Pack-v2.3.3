...
|
|     $HeadURL: https://e107german.svn.sourceforge.net/svnroot/e107german/trunk/e107_0.7/e107_langpacks/e107_plugins/chatbox_menu/languages/German/German_config.php $ 
|     $Revision: 115 $
|     $Date: 2010-09-26 06:00:45 +0200 (So, 26. Sep 2010) $
|     $Id: German_config.php 115 2010-09-26 04:00:45Z lars78 $
|     $Author: lars78 $
+----------------------------------------------------------------------------+
*/
define("CHBLAN_1", "Chatbox Einstellungen aktualisiert.");
define("CHBLAN_2", "Moderiert.");
define("CHBLAN_3", "Keine Chatboxeinträge bis jetzt.");
define("CHBLAN_4", "Mitglied");
define("CHBLAN_5", "Gast");
define("CHBLAN_6", "Blocken aufheben");
define("CHBLAN_7", "Blockieren");
define("CHBLAN_8", "Löschen");
define("CHBLAN_9", "Chatbox moderieren");
define("CHBLAN_10", "Einträge moderieren");
define("CHBLAN_11", "Anzeige der Chatboxeinträge");
define("CHBLAN_12", "Anzahl der angezeigten Einträge in der Chatbox");
...
define("CHBLAN_18", "Wörter die länger sind, als die von Ihnen hier gesetzte Zahl werden in die nächste Zeile gesetzt.");
...
define("CHBLAN_27", "- Alle Einträge löschen -");
...
define("CHBLAN_33", "Neukalkulierte Benutzerzählung");
define("CHBLAN_34", "Benutzerzählung neu kalkulieren");
define("CHBLAN_35", "Neu kalkulieren");

define("CHBLAN_36", "Chatbox Anzeigeoptionen");
define("CHBLAN_37", "Normale Chatbox");
define("CHBLAN_38", "Javascript Code verwenden um Einträge dynamisch zu aktualisieren (AJAX)");
