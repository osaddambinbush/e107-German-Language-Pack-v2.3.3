...
define("ADSTAT_LAN_2", "Der Statistik Logger wurde erfolgreich installiert. Um ihn zu aktivieren gehen Sie bitte auf die Konfigurationsseite um Ihn zu aktivieren.<br /><b>Sie mssen dem Ordner e107_plugins/log/logs 777 (chmod 777) Rechte geben</b>");
...
define("ADSTAT_LAN_13", "dies wird bestehende Statistiken beinflussen - Vorsicht!");
define("ADSTAT_LAN_14", "Seitenzugriffe");
//define("ADSTAT_LAN_15", "Statistik Einstellungen aktualisieren");
define("ADSTAT_LAN_16", "Seiten Statistik Einstellungen");
//define("ADSTAT_LAN_17", "Statistik Einstellungen aktualisiert");
...
define("ADSTAT_LAN_22", "Update Routine laufen lassen");
define("ADSTAT_LAN_23", "Logs einer früheren Version des e107 wurden gefunden, Sie können sie hier aktualisieren");
define("ADSTAT_LAN_24", "Zum Updatescript");
define("ADSTAT_LAN_25", "Ausgewählte Statistikzurücksetzungen");
define("ADSTAT_LAN_26", "Seiteneintrge entfernen");
...
define("ADSTAT_LAN_32", "Seiten Tidy");
define("ADSTAT_LAN_33", "Statistik Logging konfigurieren");
define("ADSTAT_LAN_34", "Seitenstatistik");
define("ADSTAT_LAN_35", "Kompakte Browser Info in Statistik anzeigen");
define ('ADSTAT_LAN_36', 'Data Export');
define('ADSTAT_LAN_38', "Sie müssen den Ordner e107_plugins/log/logs auf beschreibbar setzen");	// Constant compatible with 0.8
