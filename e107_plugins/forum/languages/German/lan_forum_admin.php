...
|
|     $HeadURL: https://svn.code.sf.net/p/e107german/code/trunk/e107_0.7/e107_plugins/forum/languages/German/lan_forum_admin.php $ 
|     $Revision: 164 $
|     $Date: 2011-10-15 13:33:22 +0200 (Sa, 15. Okt 2011) $
|     $Id: lan_forum_admin.php 164 2011-10-15 11:33:22Z lars78 $
|     $Author: lars78 $
+----------------------------------------------------------------------------+
*/
...
define("FORLAN_4", "Inaktivieren");
define("FORLAN_5", "Prunen durchführen");
define("FORLAN_6", "Aufheben");
define("FORLAN_7", "Forum Optionen");
define("FORLAN_8", "Geprunede Foren.");
define("FORLAN_9", "Prunen nicht notwendig.");
define("FORLAN_10", "Optionen gespeichert");
define("FORLAN_11", "Forum erstellt");
define("FORLAN_12", "Forum aktualisiert");
define("FORLAN_13", "Übergeordnetes Forum erstellt");
define("FORLAN_14", "Übergeordnetes Forum aktualisiert");
define("FORLAN_15", "Bitte markieren Sie die Bestätigungs Box um das Forum zu löschen");
define("FORLAN_16", "Foren");
define("FORLAN_17", "Keine Hauptkategorien angelegt bis jetzt");
define("FORLAN_18", "Bestehende Hauptkategorien");
define("FORLAN_19", "Bearbeiten");
define("FORLAN_20", "Löschen");
define("FORLAN_21", "markiere um zu bestätigen");
define("FORLAN_22", "Hauptkategorie");
define("FORLAN_23", "Erreichbar für?");
define("FORLAN_24", "markieren Sie hier um es für User zugänglich zu machen in der markierten Klasse");
define("FORLAN_25", "Übergeordnetes Forum aktualisieren");
define("FORLAN_26", "Übergeordnetes Forum erstellen");
define("FORLAN_27", "Sie müssen zuerst eine Hauptkategorie erstellen bevor Sie ein Forum anlegen können.");
define("FORLAN_28", "Foren");
define("FORLAN_29", "Keine Foren angelegt bis jetzt.");
define("FORLAN_30", "Bestehende Foren");
define("FORLAN_31", "Name");
define("FORLAN_32", "Beschreibung");
define("FORLAN_33", "Moderatoren");
define("FORLAN_34", "markieren Sie hier um das Forum zu aktivieren");
define("FORLAN_35", "Forum aktualisieren");
define("FORLAN_36", "Forum erstellen");
define("FORLAN_37", "Ordnen");
define("FORLAN_38", "Geschlossen");
define("FORLAN_39", "Nur für Mitglieder");
define("FORLAN_40", "Eingeschränkt");
define("FORLAN_41", "nach oben");
define("FORLAN_42", "nach unten");
define("FORLAN_43", "Voransicht / Forum Ordnung");
define("FORLAN_44", "Tabellen einschliessen");
define("FORLAN_45", "markieren Sie hier um das Forum mit den entsprechenden Layouttabellen zu umgeben");
define("FORLAN_46", "der Titel wird in der Überschrift angezeigt, wenn umgeben mit Layouttabellen markiert ist");
define("FORLAN_47", "Schalte Emailbenachrichtigung frei");
define("FORLAN_48", "markieren Sie hier um es Ihren Usern zu erlauben benachrichtigt zu werden, falls auf einen Eintrag geantwortet wurde");
define("FORLAN_49", "Schalte Umfragen frei");
define("FORLAN_50", "markieren Sie hier um es Ihren Usern zu erlauben Umfragen zu schalten");
define("FORLAN_51", "Schalte Beobachtung frei");
define("FORLAN_52", "markieren Sie hier um es Ihren Usern zu erlauben Threads zu verfolgen und benachrichtigt zu werden falls auf einen Thread geantwortet wurde.");
define("FORLAN_53", "Email Prefix");
define("FORLAN_54", "Der Text den Sie hier eingeben, wird in jedem E-mailbetreff angezeigt, den Sie über das Forum senden");
define("FORLAN_55", "Populärer Thread Schwelle");
define("FORLAN_56", "Anzahl der Einträge pro Thread bevor er als populär markiert wird");
define("FORLAN_57", "Einträge pro Seite");
define("FORLAN_58", "Anzahl der Einträge pro Seite");
define("FORLAN_59", "Löschen");
define("FORLAN_60", "Alle Threads werden gelöscht, die keine Antwort erhalten haben in der von Ihnen angegebenen Zeitspanne. <br /><b>Bitte seien Sie vorsichtig bei der Verwendung dieser Funktion</b>");
define("FORLAN_61", "Update Optionen");
define("FORLAN_62", "Forum Optionen");
...
define("FORLAN_67", "Beiträge zur Aktivierung der Signatur:");
define("FORLAN_68", "Die Anzahl der Beiträge, die benötigt werden, um jedes mal die Signatur in den Foren zu zeigen. (0 bedeutet keine)");
define("FORLAN_69", "Klassen, deren Signatur im Foren angezeigt wird:");
...
define("FORLAN_72", "Reihenfolge aktualisieren");
define("FORLAN_73", "Reihenfolge aktualisiert");
define("FORLAN_75", "Hauptkategorien");
define("FORLAN_76", "Foren erste Seite");
define("FORLAN_77", "Foren erstellen");
define("FORLAN_78", "Forum Reihenfolge");
define("FORLAN_79", "Voreinstellungen");
define("FORLAN_80", "Optionen");
define("FORLAN_81", "Sind Sie sicher diese Hauptkategorie löschen zu wollen? - Foren dieser Hauptkategorie werden somit auch gelöscht");
define("FORLAN_82", "Sind Sie sicher dieses Forum löschen zu wollen?");
define("FORLAN_83", "Hauptkategorien erstellen");
define("FORLAN_84", "Nur Mitglieder");
...
define("FORLAN_97", "Übergeordnetes Forum gelöscht");
...
define("FORLAN_101", "Hauptseiten Administrator");
define("FORLAN_102", "Schwelle");
...
define("FORLAN_114", "Eigener Benutzertitel");
define("FORLAN_115", "Markieren Sie das, damit Benutzer ihren eigenen Benutzertitel ändern können");
...
define("FORLAN_118", "Gemeldeter Eintrag gelöscht");
...
define("FORLAN_123", "Forum Anweisungen");
define("WMGLAN_1", "Anweisungen für Gäste");
define("WMGLAN_2", "Anweisungen für Mitglieder");
...
define("FORLAN_135", "Bitte frei lassen um Auto-Verkleinerung des Bildes nicht zu verhindern");
...
define("FORLAN_147", "Unterforum aktualisieren");
define("FORLAN_148", "Unterforum erstellen");
define("FORLAN_149", "Unterforen");
define("FORLAN_150", "Unterforum");
