...
define("FORLAN_11", "Zurück zum Forum");
define("FORLAN_12", "Forum Einstellungen");
define("FORLAN_13", "Sind Sie absolut sicher, dass Sie diese Umfrage löschen möchten?<br />Sobald es gelöscht wurde, kann es <b><u>nicht</u></b> abgerufen werden.");
define("FORLAN_14", "Abbrechen");
define("FORLAN_15", "Bestätigen Sie das löschen des Forum Eintrags");
define("FORLAN_16", "Bestätigen Sie das löschen der Umfrage");
define("FORLAN_17", "geschrieben von");
define("FORLAN_18", "Sind Sie absolut sicher, dass Sie dieses Forum löschen möchten");
define("FORLAN_19", "Thread und es sind verwandte Beiträge?");
define("FORLAN_20", "die Umfrage wird auch gelöscht");
define("FORLAN_21", "Sobald sie gelöscht wurden");
define("FORLAN_22", "Eintrag?<br/>Einmal gelöscht");
define("FORLAN_23", "kann nicht</u></b> abgerufen werden");
define("FORLAN_24", "Verschiebe Thread zum Forum");
define("FORLAN_25", "Thread verschieben");
define("FORLAN_26", "Antwort gelöscht");
define("FORLAN_27", "verschoben");
define("FORLAN_28", "Thread Titel nicht unbennenen");
define("FORLAN_29", "Hinzufügen");
define("FORLAN_30", "zum Titel");
define("FORLAN_31", "Umbenennen in");
define("FORLAN_32", "Umbenennen von Thread Optionen:");
