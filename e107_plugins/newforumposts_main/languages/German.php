...
|        Last Modified: 2016/12/23 12:40:48
|
|        $Author: yak $
+---------------------------------------------------------------+
*/
...
define("NFPM_L2", "Letzter Forum Eintrag");
...
define("NFPM_L9", "Anzahl der neuen Einträge zum anzeigen?");
define("NFPM_L10", "Anzeige im srollenden Bereich?");
define("NFPM_L11", "Layer höhe");
define("NFPM_L12", "Konfiguration");
define("NFPM_L13", "Einstellungen wurde aktualisiert.");
define("NFPM_L14", "Letzten Forum Eintrag anzeigen?");
define("NFPM_L15", "Standardmäßig werden letzten Themen angezeigt.");
define("NFPM_L16", "[Benutzer gelöscht]");
define("NFPM_L17", "Neue Beiträge zum beliebten Thema");
define("NFPM_L18", "Neue Einträge");
define("NFPM_L19", "Keine neuen Beiträge zum Thema");
